...
<head>
    ...
    <link
        href="https://fonts.googleapis.com/css2?family=Raleway:ital,wght@0,300;0,400;0,500;0,600;1,100;1,200&display=swap"
        rel="stylesheet">
...
<!-- Styles -->
    ...
    <script>
        const SPINNER = `<div class="spinner-border text-secondary" role="status">
